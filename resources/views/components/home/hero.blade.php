    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My Name is Gbolahan. <br/>
            I am a <span class="rounded-md text-amber-600">BACKEND DEVELOPER</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am a developer with 2+ years of experience. <br/>
            I picked up coding after my B.sc in Unilag and it's a decision i'm glad i made. <br>
            The tech community is a wonderful one and i'm happy i have been able to add my little quota to it.
